...
Plese unifromly random initial velocity of ball v0 in range [0.5, 5.0], and sample initial height of ball randomly from normal distribution (mean = $\dfrac{3}{4}\cdot NY$, std = $\dfrac{1}{12}\cdot NY$)  
...
In this program, you need to allow user to control baseball player and strive to catch fly ball.
